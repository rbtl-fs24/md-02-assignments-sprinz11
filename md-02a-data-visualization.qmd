...
3.  Do not display (ignore) the outliers in the plot. **Note: Use a search engine or an AI tool to find the solution and add the link to the solution you have found.**
    ...
    **Link**: <https://stackoverflow.com/questions/5677885/ignore-outliers-in-ggplot2-boxplot>
...
The code for the code chunk is taken from here: https://bookdown.org/alhdzsz/data_viz_ir/maps.html
